...
void show_header() {
	cout << "Главная страничка";
}
void show_content() {
	cout << "<p>Каримова Альбина Миннуровна</p>"
		"Казанский Федеральный Университет"
		"<p>Институт математики и механики им.Н.И.Лобачевского</p>"
		"<p>Направление: Математика и компьютерные науки </p>"
		"1 курс"
		"<p>Группа 05 - 107 </p> ";
}
void show_menu() {
